...
if __name__ == '__main__':
    ...
    (precision, recall, hr, mrr,
     auc, ndcg, novelty, diversity) = fpmc.learnSBPR_FPMC(tr_data, te_data,
                                                          n_epoch=args.n_epoch,
                                                          neg_batch_size=args.n_neg,
                                                          eval_per_epoch=True)

    print("Precision: %.2f, Recall: %.2f, HR: %.2f, MRR:%.2f\nAUC: %.2f, Ndcg: %.2f, Novelty: %.2f, Diversity:%.2f" %
          (precision, recall, hr, mrr, auc, ndcg, novelty, diversity))
    # print("Precision: %.2f, Recall: %.2f, HR: %.2f, MRR:%.2f" %(precision, recall, hr, mrr))
